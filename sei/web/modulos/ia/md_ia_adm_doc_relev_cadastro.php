...
try {
    ...
    if ($_GET['id_md_ia_adm_doc_relev'] || $_POST["hdnIdMdIaAdmDocRelev"]) {
        $id_md_ia_adm_doc_relev = $_GET['id_md_ia_adm_doc_relev'] ? $_GET['id_md_ia_adm_doc_relev'] : $_POST["hdnIdMdIaAdmDocRelev"];
        ...
        $objMdIaAdmDocRelevDTO->setNumIdMdIaAdmDocRelev($id_md_ia_adm_doc_relev);
        ...
        $strLupaTpProcesso = $objMdIaAdmDocRelevRN->montarArrTpProcesso($id_md_ia_adm_doc_relev);
        ...
        $objMdIaAdmSegDocRelevDTO->setNumIdMdIaAdmDocRelev($id_md_ia_adm_doc_relev);
    ...
    switch ($_GET['acao']) {
        case 'md_ia_adm_doc_relev_cadastrar':
            ...
            if (isset($_POST['sbmCadastrarMdIaAdmDocRelev'])) {
                try {
                    ...
                    header('Location: ' . SessaoSEI::getInstance()->assinarLink('controlador.php?acao=' . PaginaSEI::getInstance()->getAcaoRetorno() . '&acao_origem=' . $_GET['acao'] . '&id_md_ia_adm_doc_relev=' . $objMdIaAdmDocRelevDTO->getNumIdMdIaAdmDocRelev() . PaginaSEI::getInstance()->montarAncora($objMdIaAdmDocRelevDTO->getNumIdMdIaAdmDocRelev())));
                    die;
                } catch (Exception $e) {
        ...
        case 'md_ia_adm_doc_relev_alterar':
            ...
            $arrComandos[] = '<button type="button" accesskey="C" name="btnCancelar" id="btnCancelar" value="Cancelar" onclick="location.href=\'' . SessaoSEI::getInstance()->assinarLink('controlador.php?acao=' . PaginaSEI::getInstance()->getAcaoRetorno() . '&acao_origem=' . $_GET['acao'] . '&id_md_ia_adm_doc_relev=' . $objMdIaAdmDocRelevDTO->getNumIdMdIaAdmDocRelev() . PaginaSEI::getInstance()->montarAncora($objMdIaAdmDocRelevDTO->getNumIdMdIaAdmDocRelev())) . '\';" class="infraButton"><span class="infraTeclaAtalho">C</span>ancelar</button>';
            $alterar = 'disabled';
            ...
            if (isset($_POST['sbmAlterarMdIaAdmDocRelev'])) {
                try {
                    ...
                    $arrSegmentoDocumento = PaginaSEI::getInstance()->getArrItensTabelaDinamica($_POST['hdnTbPercRelevSegmento']);
                    $objMdIaAdmSegDocRelevRN = new MdIaAdmSegDocRelevRN();
                    $objMdIaAdmSegDocRelevRN->excluirRelacionamento($idMdIaAdmDocRelev);
                    $objMdIaAdmSegDocRelevRN->cadastrarRelacionamento(array($arrSegmentoDocumento, $idMdIaAdmDocRelev));

                    PaginaSEI::getInstance()->adicionarMensagem('Documento Relevante "' . $idMdIaAdmDocRelev . '" alterado com sucesso.');
                    header('Location: ' . SessaoSEI::getInstance()->assinarLink('controlador.php?acao=' . PaginaSEI::getInstance()->getAcaoRetorno() . '&acao_origem=' . $_GET['acao'] . '&id_md_ia_adm_doc_relev=' . $idMdIaAdmDocRelev . PaginaSEI::getInstance()->montarAncora($idMdIaAdmDocRelev)));
                    die;
                } catch (Exception $e) {
                    PaginaSEI::getInstance()->processarExcecao($e);
                }
        ...
        case 'md_ia_adm_doc_relev_consultar':
            ...
            $arrComandos[] = '<button type="button" accesskey="F" name="btnFechar" value="Fechar" onclick="location.href=\'' . SessaoSEI::getInstance()->assinarLink('controlador.php?acao=' . PaginaSEI::getInstance()->getAcaoRetorno() . '&acao_origem=' . $_GET['acao'] . '&id_md_ia_adm_doc_relev=' . $idMdIaAdmDocRelev . PaginaSEI::getInstance()->montarAncora($idMdIaAdmDocRelev)) . '\';" class="infraButton"><span class="infraTeclaAtalho">F</span>echar</button>';
    ...
    if ($arrObjMdIaAdmSegDocRelevDTO) {
        $tabelaPercRelevMet = "";
